    ...
    function gonderMusteriYorumu() {
        ...
        let reviewObj = {
            ...
            comment: comment,
            customerName: currentTrackingData.musteri || "İsimsiz Müşteri",
            mobilyaTuru: currentTrackingData.mobilyaTuru || "Özel Proje",
        ...
        db.collection("reviews").doc(orderId).set(reviewObj).then(() => {
            ...
            resultContainer.innerHTML = `
                <div style="background-color: var(--bg-dark); padding: 12px; border-radius: 8px; border: 1px solid var(--border); text-align: center;">
                    ...
                    <p style="font-size: 11.5px; color: var(--text-muted); margin-bottom: 10px;">Geri bildiriminiz başarıyla iletildi.</p>
