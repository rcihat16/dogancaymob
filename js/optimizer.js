...
// Bind optimizer functions and variables to window for global access
window.toggleOptCustomStock = toggleOptCustomStock;
window.optYasarYeniSatir = optYasarYeniSatir;
window.optYasarEkleSatirVeri = optYasarEkleSatirVeri;
window.optYasarSatirSil = optYasarSatirSil;
window.optYasarListeyiTemizle = optYasarListeyiTemizle;
window.optYasarHepsiniTikla = optYasarHepsiniTikla;
window.tekliftenKesimListesiCikar = tekliftenKesimListesiCikar;
window.optimizasyonHesaplaCiz = optimizasyonHesaplaCiz;
window.yazdirOptPlan = yazdirOptPlan;
